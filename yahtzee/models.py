...
class UsersGames(db.Model):
    ...
    ones = db.Column(db.Integer, nullable=False, default=0)
    twos = db.Column(db.Integer, nullable=False, default=0)
    threes = db.Column(db.Integer, nullable=False, default=0)
    ...
    three_of_a_kind = db.Column(db.Integer, nullable=False, default=0)
    four_of_a_kind = db.Column(db.Integer, nullable=False, default=0)
    full_house = db.Column(db.Integer, nullable=False, default=0)
    small_straight = db.Column(db.Integer, nullable=False, default=0)
    large_straight = db.Column(db.Integer, nullable=False, default=0)
    yahtzee = db.Column(db.Integer, nullable=False, default=0)
    chance = db.Column(db.Integer, nullable=False, default=0)
    yahtzee_bonus = db.Column(db.Integer, nullable=False, default=0)
    top_score = db.Column(db.Integer, nullable=False, default=0)
    top_bonus_score = db.Column(db.Integer, nullable=False, default=0)
    top_bonus_score_delta = db.Column(db.Integer, nullable=False, default=0)
    total_top_score = db.Column(db.Integer, nullable=False, default=0)
    total_bottom_score = db.Column(db.Integer, nullable=False, default=0)
    grand_total_score = db.Column(db.Integer, nullable=False, default=0)
    user_id = db.Column(
